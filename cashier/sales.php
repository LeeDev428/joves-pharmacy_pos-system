...
// Get sales data for current cashier
...
");
$dailySales->execute([$userId]);
$dailySales = $dailySales->fetchAll(PDO::FETCH_ASSOC);

// Get today's stats for current cashier
...
$todayStats = $todayStats->fetch(PDO::FETCH_ASSOC);

// Get top products sold by this cashier today
...
<div class="row mb-4">
    ...
    <div class="col-lg-8 mb-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0">
                <h5 class="mb-0"><i class="fas fa-chart-line me-2 text-primary"></i>My Daily Sales Trend (Last 30 Days)</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0">
                <h5 class="mb-0"><i class="fas fa-star me-2 text-warning"></i>My Top Products Today</h5>
            </div>
            <div class="card-body">
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0">
        <h5 class="mb-0"><i class="fas fa-table me-2 text-success"></i>My Daily Sales Report</h5>
    </div>
    <div class="card-body">
